...
public class QOffer extends EntityPathBase<Offer> {
    ...
    private static final long serialVersionUID = 1057102510L;
    ...
    public final EnumPath<com.agregio.park.constant.ChunkType> chunk = createEnum("chunk", com.agregio.park.constant.ChunkType.class);

    public final DateTimePath<java.util.Date> day = createDateTime("day", java.util.Date.class);

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final EnumPath<com.agregio.park.constant.MarketType> market = createEnum("market", com.agregio.park.constant.MarketType.class);
